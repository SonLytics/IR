...
REM  Fork version:	3 | 03/07/18
REM  Fork author:	@datagoon, @ironlinesec
REM  Fork project:	IR
REM ############################################################################
...
REM Autoruns
echo y | autorunsc64.exe -accepteula -a * -h -m -s -c -vt -vr 1> autoruns.csv
 
REM SigCheck
echo y | sigcheck64.exe -accepteula -c -e -u -h -vt -vr c:\windows\system32 1> sigcheck.csv
:pause
